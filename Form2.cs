...
namespace LoginApplication
{
    public partial class Registration : Form
    {
        ...
        {
            string connectionString = ("Data Source=DESKTOP-L2EICV1;Initial Catalog=userregcs;Integrated Security=True");
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(query, con))
                {
                    ...
                    cmd.Parameters.AddWithValue("@gender", cmbGender.SelectedItem != null ? cmbGender.SelectedItem.ToString() : "");
